...
from model.utils.custom_mlp import MLP, Exp
from model.utils.mnist_cached import MNISTCached, mkdir_p, setup_data_loaders
from model.utils.vae_plots import mnist_test_tsne_ssvae, plot_conditional_samples_ssvae
from .ga import NaiveSentenceEncoder, long2onehot
...
class SSVAE(nn.Module):
    ...
    """
    def __init__(self, vocab_size, embedding_size=300, output_size=10, input_size=784,
                 z_dim=50, hidden_layers=[500,],
    ...
    def setup_networks(self):
        ...
        self.sentence_encoder = NaiveSentenceEncoder(self.vocab_size, self.embedding_size,
                                                     hidden_sizes[-1], self.input_size, 'lstm')
    ...
    def model(self, xp, xh, ys=None):
        ...
        ys = long2onehot(ys, self.output_size)
    ...
    def model_classify(self, xp, xh, ys=None):
        """
    ...
    def guide_classify(self, xp, xh, ys=None):
        """
